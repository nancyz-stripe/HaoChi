// WGS-84 to GCJ-02 coordinate conversion for China map providers
// GCJ-02 is the coordinate system mandated by China for map services
...
/** Convert WGS-84 coordinates to GCJ-02 (used by Amap/Gaode) */
...
export function isLikelyInChina(): boolean {
  try {
    ...
    // Also check language as a secondary signal
